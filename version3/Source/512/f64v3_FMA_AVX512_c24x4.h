...
public:
    ...
    virtual double run_kernel(size_t iterations) const override{
      if(1==1){
        //original version
        //Skylake 6148 two sockets: 250 W, 2.8 TFlops 
        ...
        //modified version:random
        //Skylake 6148 two sockets: 260 W, 2.8 TFlops 
        static unsigned int seed  = 42;
        const __m512d mul0 = _mm512_set1_pd((double)(rand_r(&seed)/(double)RAND_MAX));
        const __m512d mul1 = _mm512_set1_pd((double)(rand_r(&seed)/(double)RAND_MAX));
        
        __m512d r00 = _mm512_set1_pd((double)(rand_r(&seed)/(double)RAND_MAX));
        __m512d r01 = _mm512_set1_pd((double)(rand_r(&seed)/(double)RAND_MAX));
        __m512d r02 = _mm512_set1_pd((double)(rand_r(&seed)/(double)RAND_MAX));
        __m512d r03 = _mm512_set1_pd((double)(rand_r(&seed)/(double)RAND_MAX));
        __m512d r04 = _mm512_set1_pd((double)(rand_r(&seed)/(double)RAND_MAX));
        __m512d r05 = _mm512_set1_pd((double)(rand_r(&seed)/(double)RAND_MAX));
        __m512d r06 = _mm512_set1_pd((double)(rand_r(&seed)/(double)RAND_MAX));
        __m512d r07 = _mm512_set1_pd((double)(rand_r(&seed)/(double)RAND_MAX));
        __m512d r08 = _mm512_set1_pd((double)(rand_r(&seed)/(double)RAND_MAX));
        __m512d r09 = _mm512_set1_pd((double)(rand_r(&seed)/(double)RAND_MAX));
        __m512d r10 = _mm512_set1_pd((double)(rand_r(&seed)/(double)RAND_MAX));
        __m512d r11 = _mm512_set1_pd((double)(rand_r(&seed)/(double)RAND_MAX));
        __m512d r12 = _mm512_set1_pd((double)(rand_r(&seed)/(double)RAND_MAX));
        __m512d r13 = _mm512_set1_pd((double)(rand_r(&seed)/(double)RAND_MAX));
        __m512d r14 = _mm512_set1_pd((double)(rand_r(&seed)/(double)RAND_MAX));
        __m512d r15 = _mm512_set1_pd((double)(rand_r(&seed)/(double)RAND_MAX));
        __m512d r16 = _mm512_set1_pd((double)(rand_r(&seed)/(double)RAND_MAX));
        __m512d r17 = _mm512_set1_pd((double)(rand_r(&seed)/(double)RAND_MAX));
        __m512d r18 = _mm512_set1_pd((double)(rand_r(&seed)/(double)RAND_MAX));
        __m512d r19 = _mm512_set1_pd((double)(rand_r(&seed)/(double)RAND_MAX));
        __m512d r20 = _mm512_set1_pd((double)(rand_r(&seed)/(double)RAND_MAX));
        __m512d r21 = _mm512_set1_pd((double)(rand_r(&seed)/(double)RAND_MAX));
        __m512d r22 = _mm512_set1_pd((double)(rand_r(&seed)/(double)RAND_MAX));
        __m512d r23 = _mm512_set1_pd((double)(rand_r(&seed)/(double)RAND_MAX));
        //std::cout << (double)(rand_r(&seed)/(double)RAND_MAX) << " " << (double)(rand_r(&seed)/(double)RAND_MAX) << std::endl;
        do{
            r00 = _mm512_fmadd_pd(mul0, mul1, r00);
            r01 = _mm512_fmadd_pd(mul0, mul1, r01);
            r02 = _mm512_fmadd_pd(mul0, mul1, r02);
        ...
        //modified version: ints
        //Skylake 6148 two sockets: 220W, 2.8 TFlops 
        static unsigned int seed  = 42;
        const __m512d mul0 = _mm512_set1_pd((double)(2.0));
        const __m512d mul1 = _mm512_set1_pd((double)(1.0));
        
        __m512d r00 = _mm512_set1_pd((double)(1));
        __m512d r01 = _mm512_set1_pd((double)(1));
        __m512d r02 = _mm512_set1_pd((double)(1));
        __m512d r03 = _mm512_set1_pd((double)(1));
        __m512d r04 = _mm512_set1_pd((double)(1));
        __m512d r05 = _mm512_set1_pd((double)(1));
        __m512d r06 = _mm512_set1_pd((double)(1));
        __m512d r07 = _mm512_set1_pd((double)(1));
        __m512d r08 = _mm512_set1_pd((double)(1));
        __m512d r09 = _mm512_set1_pd((double)(1));
        __m512d r10 = _mm512_set1_pd((double)(1));
        __m512d r11 = _mm512_set1_pd((double)(1));
        __m512d r12 = _mm512_set1_pd((double)(1));
        __m512d r13 = _mm512_set1_pd((double)(1));
        __m512d r14 = _mm512_set1_pd((double)(1));
        __m512d r15 = _mm512_set1_pd((double)(1));
        __m512d r16 = _mm512_set1_pd((double)(1));
        __m512d r17 = _mm512_set1_pd((double)(1));
        __m512d r18 = _mm512_set1_pd((double)(1));
        __m512d r19 = _mm512_set1_pd((double)(1));
        __m512d r20 = _mm512_set1_pd((double)(1));
        __m512d r21 = _mm512_set1_pd((double)(1));
        __m512d r22 = _mm512_set1_pd((double)(1));
        __m512d r23 = _mm512_set1_pd((double)(1));
        do{
            r00 = _mm512_fmadd_pd(mul0, mul1, r00);
            r01 = _mm512_fmadd_pd(mul0, mul1, r01);
            r02 = _mm512_fmadd_pd(mul0, mul1, r02);
